...
simulation_results_dir = os.path.expanduser("~/mySimTools/simulation_results")
output_dir = os.path.expanduser("~/mySimTools/McPAT_results")
script_path = os.path.expanduser("~/mySimTools/scripts/McPAT/gem5toMcPAT_cortexA76.py")
xml_path = os.path.expanduser("~/mySimTools/scripts/McPAT/ARM_A76_2.1GHz.xml")
